...
if abs(price - lower_multiple) <= abs(upper_multiple - price):
    closest_price = lower_multiple if abs(price - lower_multiple) < abs(upper_multiple - price) else upper_multiple
else:
